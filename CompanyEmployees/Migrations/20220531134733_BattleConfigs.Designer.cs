...
namespace HamsterWars.Migrations
{
    ...
    [Migration("20220531134733_BattleConfigs")]
    partial class BattleConfigs
    {
            ...
            modelBuilder.Entity("Domain.Entities.Models.Battle", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            LoserHamsterId = 1,
                            TimeOfPost = new DateTime(2022, 5, 31, 15, 47, 33, 256, DateTimeKind.Local).AddTicks(6867),
                            WinnerHamsterId = 2
                        },
                        new
                        {
                            Id = 2,
                            LoserHamsterId = 3,
                            TimeOfPost = new DateTime(2022, 5, 31, 15, 47, 33, 256, DateTimeKind.Local).AddTicks(6903),
                            WinnerHamsterId = 2
                        },
                        new
                        {
                            Id = 3,
                            LoserHamsterId = 2,
                            TimeOfPost = new DateTime(2022, 5, 31, 15, 47, 33, 256, DateTimeKind.Local).AddTicks(6905),
                            WinnerHamsterId = 4
                        });
                });
